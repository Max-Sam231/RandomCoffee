...
import { BarChartOutlined, BarsOutlined,  CloseOutlined, EnvironmentOutlined, PoweroffOutlined, UserOutlined } from '@ant-design/icons';
  ...
  return (
    <Layout className='mainContainer' >
      ...
      >
        ...
        <Button className={'buttonSingOut'}
         type="primary" color="danger" onClick={() => logout()}>
        <PoweroffOutlined />
        </Button>
      </Sider>
      <Layout>
